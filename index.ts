...
function buildResumePage() {
    main
        ...
        .append(
            ...
            elem({tag: 'h4'}).html(`I'd been a concert pianist since I was 5. By high school I started composing movie soundtracks.<br>
            ...
            elem({tag: 'h4'}).html(`Music production is done with a computer, and as I produced more, I understood computers better, and eventually
